...
![Monatsansicht der Zeiterfassung mit erfassten Arbeitszeiten](docs/screenshots/kalender-v1.23.3.png)
...
![Tages-Dialog mit Arbeitszeit, Reservierung und Erinnerung](docs/screenshots/tagesdialog-v1.23.3.png)
...
![Sende-Dialog mit Zeitraum- und Kategorieauswahl](docs/screenshots/senden-v1.23.3.png)

*Der Sende-Dialog: Zeitraum, Kategorie-Filter und die Gesamtstunden vor dem Absenden.*

![Erzeugter PDF-Bericht](docs/screenshots/bericht-v1.23.3.png)
...
- **UI-Skalierung** — Stufenloser Skalierungsfaktor für die Oberfläche (gerätelokal). Unter Windows folgt die App zusätzlich der Anzeigeskalierung und bleibt dabei scharf *(ab --VERSION--)*; der Faktor gilt dann obendrauf
- **Cross-Platform-Installer** — Per PyInstaller gebaut, als Setup-Exe (Windows), DMG (macOS) und AppImage (Linux) paketierbar

![Einstellungs-Dialog, Tab Arbeitszeit](docs/screenshots/einstellungen-v1.23.3.png)
...
Die App aus dem Quellcode starten, Tests laufen lassen, selbst bauen oder einen
Pull Request aufmachen: Das steht in **[CONTRIBUTING.md](CONTRIBUTING.md)** —
Voraussetzungen und Setup, Projektstruktur, Build je Plattform, Tests und die
