...
- **Urlaub** — Urlaubszeiträume als Einheit eintragen (Name, Von/Bis, Stunden pro Tag oder Gesamtstunden auf die Arbeitstage verteilt); im Kalender ein durchgehender türkiser Block über Wochenenden und Feiertage hinweg, einzelne Tage nachträglich anpassbar (halber Urlaubstag). Optional als Ganztags-Termine im Google Kalender. Gerätelokal — Urlaub reist **nicht** über den Drive-Sync mit
