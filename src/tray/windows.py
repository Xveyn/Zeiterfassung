...
installiert sie nicht, und `src.ui -> src.tray -> src.tray.windows` muss
auf jeder Plattform importierbar bleiben.
"""
...
class _PystrayBackend:
    ...
    native MacTrayBackend, s. tray/mac.py). Body unverändert ggü. dem früheren
